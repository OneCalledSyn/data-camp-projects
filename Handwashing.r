...
yearly <- yearly %>% mutate(proportion_deaths = yearly$deaths / yearly$births)
...
ggplot(monthly, aes(x = date, y = proportion_deaths, color = handwashing_started)) + geom_line() + labs(x = "Date", y = "Death Prop")
