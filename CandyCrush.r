...
ggplot(difficulty, aes(x = level, y = p_win)) + geom_line() + scale_x_continuous(breaks = 1:15) + scale_y_continuous(label = scales::percent)+ geom_point() + geom_hline(yintercept = .1)
...
ggplot(difficulty, aes(x = level, y = p_win)) + geom_line() + scale_x_continuous(breaks = 1:15) + scale_y_continuous(label = scales::percent)+ geom_point() + geom_hline(yintercept = .1) + geom_errorbar(aes(ymin = (p_win - error), ymax = (p_win + error)))
